...
import { PermissionRoleOrderByWithAggregationInput } from './permission-role-order-by-with-aggregation.input';
import { PermissionRoleScalarFieldEnum } from './permission-role-scalar-field.enum';
import { PermissionRoleScalarWhereWithAggregatesInput } from './permission-role-scalar-where-with-aggregates.input';
...
@ArgsType()
export class PermissionRoleGroupByArgs {

    @Field(() => PermissionRoleWhereInput, {nullable:true})
    @Type(() => PermissionRoleWhereInput)
    where?: PermissionRoleWhereInput;

    @Field(() => [PermissionRoleOrderByWithAggregationInput], {nullable:true})
    orderBy?: Array<PermissionRoleOrderByWithAggregationInput>;

    @Field(() => [PermissionRoleScalarFieldEnum], {nullable:false})
    by!: Array<keyof typeof PermissionRoleScalarFieldEnum>;
